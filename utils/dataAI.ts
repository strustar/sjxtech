...
export const getDataAI = () => {
  return {
    chatbots: [
      ...
      {
        title: 'Llama',
        description: '• LLaMA(Large Language Model Meta AI). • 연구 및 상업적 용도로 무료 제공',
        ...
        },
      {
        ...
        {
        title: 'Goover',
        description: '• 솔트룩스의 미국 자회사에서 개발한 AI 기반 검색 서비스. • 개인 맞춤형 콘텐츠 제공하며, 심층 리포트 생성 가능',
        url: 'https://goover.ai/',
        category: 'AI 챗봇',
        }
    ],
    ...
    videoAI: [
      ...
      {
        title: 'Fliki',
        description: '• AI 기반 텍스트-음성-비디오 변환 도구. • 다국어 AI 보이스 지원, 자동 자막 생성',
        url: 'https://fliki.ai/',
        category: '비디오 생성',
        },
        {
        title: 'VEED',
        description: '• 브라우저 기반 비디오 편집 도구. • AI 자동 자막 및 번역, 화면 녹화 및 웹캠 녹화',
    ...
    presentationAI: [
      ...
      },
      {
        ...
        description: '• AI 기반 프레젠테이션 자동 생성. • 브랜드 디자인 자동 적용, 실시간 데이터 시각화',
        url: 'https://presentations.ai/',
        category: 'PPT 생성',
        },
        {
        title: 'Prezi',
        description: '• 줌 기반 다이나믹 프레젠테이션 도구. • AI 기반 디자인 제안, 비디오 프레젠테이션 지원',
        url: 'https://prezi.com/',
        category: 'PPT 생성',
        }
    ],
    ...
    imageAI: [
      ...
      {
        title: 'DreamStudio',
        description: '• Stability AI의 텍스트-이미지 생성 도구. • Stable Diffusion 모델 기반 고품질 이미지 생성과 편집',
        url: 'https://dreamstudio.ai/',
        category: '이미지 생성',
      },
      {
        title: 'Napkin AI',
        description: '• 텍스트를 시각적 요소로 변환하는 AI 기반 도구. • 다이어그램, 차트, 인포그래픽 등 자동 생성',
        url: 'https://napkin.ai/',
        category: '시각화/다이어그램',
      }
    ],
    ...
    etcAI: [
      {
        "title": "Notion AI",
        "description": "• 문서 작성 및 노트 정리를 위한 AI 도구. • 자동 완성, 요약, 번역 등 다양한 기능 제공. • 생산성 향상에 도움.",
        "url": "https://www.notion.so/product/ai",
        "category": "문서 작성"
      },
      {
        "title": "Otter.ai",
        "description": "• 음성 녹음 및 실시간 전사 서비스. • 회의, 강의 등의 음성을 텍스트로 변환. • 팀 협업 및 공유 기능 지원.",
        "url": "https://otter.ai",
        "category": "음성 전사"
      },
      {
        "title": "Grammarly",
        "description": "• 문법 및 철자 교정을 위한 AI 도구. • 문장 구조, 어휘 제안, 스타일 개선 기능 제공. • 다양한 플랫폼과의 통합 지원.",
        "url": "https://www.grammarly.com",
        "category": "문법 교정"
      },
      {
        "title": "Descript",
        "description": "• 오디오 및 비디오 편집을 위한 AI 도구. • 텍스트 기반의 편집, 자동 전사, 음성 합성 기능 제공. • 팟캐스트 및 영상 제작에 유용.",
        "url": "https://www.descript.com",
        "category": "오디오 편집"
      },
      {
        "title": "Copy.ai",
        "description": "• 마케팅 카피 및 콘텐츠 생성을 위한 AI 도구. • 블로그, 소셜 미디어 포스트, 광고 문구 등 다양한 콘텐츠 작성",
        "url": "https://www.copy.ai",
        "category": "카피라이팅"
      },
      {
        "title": "Jasper",
        "description": "• AI 기반의 콘텐츠 생성 플랫폼. • 블로그, 소셜 미디어, 이메일 등 다양한 형식의 콘텐츠 작성",
        "url": "https://www.jasper.ai",
        "category": "콘텐츠 생성"
      },
      {
        "title": "Murf",
        "description": "• 텍스트를 자연스러운 음성으로 변환하는 AI 음성 합성 도구. • 다양한 목소리와 언어 선택 가능.",
        "url": "https://murf.ai",
        "category": "음성 합성"
      },
      {
        "title": "Krisp",
        "description": "• 실시간 통화 및 녹음 시 배경 소음 제거를 위한 AI 도구. • 원격 근무 및 온라인 회의 시 유용.",
        "url": "https://krisp.ai",
        "category": "노이즈 제거"
      },
      {
        "title": "Speechify",
        "description": "• 텍스트를 음성으로 읽어주는 TTS(Text-to-Speech) 도구. • 다양한 음성 선택 및 속도 조절 가능.",
        "url": "https://speechify.com",
        "category": "TTS"
      },
      {
        "title": "Soundraw",
        "description": "• AI를 활용한 음악 생성 도구. • 사용자 지정에 따른 맞춤형 음악 트랙 생성 가능.",
        "url": "https://soundraw.io",
        "category": "음악 생성"
      },
      {
        "title": "Fireflies.ai",
        "description": "• 회의 녹음 및 자동 전사, 요약 기능 제공. • 팀 협업을 위한 메모 공유 및 검색 기능 지원.",
        "url": "https://fireflies.ai",
        "category": "미팅 기록"
      },
      {
        "title": "Synthesia",
        "description": "• AI 기반의 비디오 아바타 생성 도구. • 텍스트를 입력하면 아바타가 해당 내용을 말하는 비디오 생성.",
        "url": "https://www.synthesia.io",
        "category": "비디오 아바타"
      },
      {
        "title": "Wordtune",
        "description": "• 글쓰기 지원을 위한 AI 도구. • 문장 재구성, 표현 개선, 번역 기능 제공.",
        "url": "https://www.wordtune.com",
        "category": "글쓰기 지원"
      },
      {
        "title": "Rytr",
        "description": "• AI 기반의 콘텐츠 생성 도구. • 블로그 글, 광고 카피, 소셜 미디어 콘텐츠 등 다양한 형식 지원.",
        "url": "https://rytr.me",
        "category": "콘텐츠 생성"
      },
      {
        "title": "Typeface",
        "description": "• Mac용 폰트 관리 도구. • 폰트 미리보기, 정리, 설치 기능 제공.",
        "url": "https://typefaceapp.com",
        "category": "폰트 관리"
      },
      {
        "title": "Writesonic",
        "description": "• AI 기반의 마케팅 콘텐츠 생성 도구. • 블로그 글, 광고 카피, 소셜 미디어 콘텐츠 등 다양한 형식 지원.",
        "url": "https://writesonic.com",
        "category": "콘텐츠 생성"
      },
      {
        "title": "Frase",
        "description": "• SEO 최적화를 위한 AI 콘텐츠 도구. • 콘텐츠 브리프 생성, 키워드 연구, 콘텐츠 최적화 기능 제공.",
        "url": "https://www.frase.io",
        "category": "SEO"
      },
      {
        "title": "Peppertype",
        "description": "• AI 기반의 마케팅 콘텐츠 생성 도구. • 블로그 글, 소셜 미디어 포스트, 광고 카피 등 다양한 형식 지원.",
        "url": "https://www.peppertype.ai",
        "category": "마케팅"
      },
      {
        "title": "Pictory",
        "description": "• AI를 활용한 비디오 생성 및 편집 도구. • 텍스트를 비디오로 변환, 자동 요약, 자막 추가 기능 제공.",
        "url": "https://pictory.ai",
        "category": "비디오 편집"
      },
      {
        "title": "Lumen5",
        "description": "• AI 기반의 비디오 마케팅 도구. • 블로그 글, 기사 등을 비디오 콘텐츠로 변환하여 마케팅 활용.",
